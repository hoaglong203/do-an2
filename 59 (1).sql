...
-- Thời gian đã tạo: Th10 21, 2024 lúc 05:03 AM
...
INSERT INTO `admin` (`id_admin`, `name_admin`, `email_admin`, `phone_number_admin`, `address_admin`, `image`, `status_admin`, `lever`, `password`, `token_admin`) VALUES
(4, 'Công phạm', 'congphamtienthanh@gmail.com', '0392524411', '30/4 hạ long, Quảng Ninh', 'Công phạm1641833277.jpg', 1, 1, 'cong', '182189d64ca88e2073e4a5753ec1c9cdce5ccbe9'),
(5, 'Admin pro vip', 'hoangschool@gmail.com', '0859336352', 'Yên Nghĩa, Hà Đông, Hà Nội', 'Admin pro vip1732076261.jpg', 1, 2, 'cong', 'e1d7520ae5687837ea6b8420eebf22b91bef62d5'),
(8, 'cong j2sholl', 'cong.pttc@gmail.com', '936445789', '30/4 hạ long móng cái', 'none', 1, 1, 'cong', NULL),
(9, 'sinh vien pnk', '20010886@st.phenikaa-uni.edu.vn', '0396333541', 'yên nghĩa, hà đong', 'sinh vien pnk1641892120.png', -1, 1, 'cong', NULL),
(10, 'Cong Pham nhé', 'cong1234@gmail.com', '01354248302', 'yên nghĩa, hà đong', 'none', 0, 1, 'cong', NULL);
...
(3, 4, 'Khóa học tiếng Anh cơ bản cho người mới bắt đầu', 'Khóa học \"Tiếng Anh cơ bản cho người mới bắt đầu\" được thiết kế dành riêng cho những ai mới bắt đầu làm quen với ngôn ngữ này. Với phương pháp giảng dạy hiện đại, dễ hiểu và lộ trình học tập rõ ràng, khóa học sẽ giúp bạn xây dựng nền tảng vững chắc để tự tin giao tiếp trong các tình huống hàng ngày.\r\n\r\nĐiểm nổi bật của khóa học:\r\n\r\nPhát âm chuẩn: Học cách phát âm đúng từ cơ bản đến nâng cao với sự hỗ trợ của hướng dẫn phát âm chi tiết.\r\nTừ vựng thông dụng: Bổ sung hơn 500 từ và cụm từ phổ biến, giúp bạn dễ dàng ứng dụng trong giao tiếp.\r\nNgữ pháp nền tảng: Giải thích đơn giản, dễ nhớ các chủ điểm ngữ pháp cơ bản như thì hiện tại đơn, quá khứ đơn, câu hỏi và câu phủ định.\r\nKỹ năng nghe và nói: Phát triển kỹ năng giao tiếp thông qua các bài tập thực hành và tình huống thực tế.\r\nHọc mọi lúc, mọi nơi: Linh hoạt học tập với các bài giảng trực tuyến, tài liệu tải về và bài tập tương tác.\r\nĐối tượng tham gia:\r\n\r\nNgười chưa từng học tiếng Anh hoặc mới bắt đầu học.\r\nNgười cần cải thiện khả năng giao tiếp cơ bản để sử dụng trong công việc và cuộc sống.\r\nHãy tham gia ngay để mở ra cánh cửa tri thức và cơ hội mới với tiếng Anh! ?', 'Nguyễn Nam Long', 'lotrinhkhtructuyen.jpg', 1, 1200000, '2022-01-11 02:01:54'),
(14, 4, 'Khóa học html-css-javascript-php ', 'Khóa học cung cấp các kiến thức căn bản để học viên có thể đi làm được ở vị trí fullstack web developer. Học viên học được cách làm việc nhóm, giải quyết vấn đề, hiểu được quy trình, công cụ làm việc như trong thực tế.\r\n\r\nLưu ý: Hiện nay có một số kẻ xấu đang bán khóa học này dưới dạng video, đó là hành vi ăn cắp, mình đã làm việc với bên công an để có biện pháp xử lý. Các video họ bán đã quá cũ, không cập nhật các kiến thức mới như khóa học này. Một số trường hợp bị lừa đảo, gửi file không mở được. Không được cấp tài khoản và API để thực hành.\r\n\r\nĐể đăng ký khóa học hoặc bạn cần tư vấn, vui lòng kéo xuống dưới cùng.\r\n\r\nNếu học viên đã học sơ qua về lập trình web, khóa học này là cơ hội để hệ thống hóa kiến thức, học lại một cách bài bản, bù các kiến thức bị thiếu. Bởi vì chỉ cần “một cuốn sách, một người thầy” là đủ.\r\n\r\nKhóa học dành cho các học viên có kiến thức lập trình căn bản, có thời gian, sẵn sàng đeo bám khóa học đến cùng :) Học cho đến lúc nào đi làm được thì thôi.\r\n\r\nHọc viên có một người mentor bên cạnh, như một người bạn, sẵn sàng chia sẻ định hướng để phát triển bản thân trong ngành lập trình.\r\n\r\n', 'Nguyễn Nam Long', 'Khóa học html-css-javascript-php 1642081103.png', 0, 950000, '2022-01-13 06:38:23'),
...
(28, 5, 3, 1200000, 0, NULL, '2024-11-21 03:38:48');
...
(3, 'Minh Hoang', 'sonarlin@gmail.com', '0396369665', 'null', 'cong', ''),
(4, 'Test lại', 'cong.test@gmail.com', '0936933214', 'Test chăng1644249252.jpg', 'cong', '6dd54be6ed514e482b4bdd8294db799ac6fe7903'),
(5, 'Hoàng', 'hoanghuy12042404@gmail.com', '0859226352', 'null', 'Hoang12345@', '03de9143b52b3a8f9711b32b1037d9221c4909ed');
